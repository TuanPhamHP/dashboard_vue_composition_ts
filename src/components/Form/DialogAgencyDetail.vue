 ...
 <v-dialog v-model="isVisible" persistent max-width="80vw">
  <v-card class="dialog-agency-detail">
   ...
   <v-card-text class="">
    <div class="box-top mb-4 col-xxl-12">
     <div class="row my-0 justify-content-between">
      <div class="col-xxl-6 mb-3 agency-row-info">
       <span class="agency-info-txt"> No . </span>
       <span class="agency-info-input">
        <input type="text" class="w-100" />
       </span>
      </div>
      <div class="col-xxl-6 mb-3 agency-row-info">
       <span class="agency-info-txt"> Address </span>
       <span class="agency-info-input">
        <input type="text" class="w-100" />
       </span>
      </div>
    ...
    <TableAgencyDetail :table-data="tableData" :table-loading="loadingTable" :headers="headers" />
   </v-card-text>
   <v-card-actions>
    <v-spacer></v-spacer>
    <v-btn text @click="btnCancelClick" class="buton-secondary button-size border-width-2px text-transform-unset mr-4"> Close </v-btn>
    <!-- <v-btn
                text
