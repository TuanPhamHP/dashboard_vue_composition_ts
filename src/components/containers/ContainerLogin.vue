  ...
  <div>
    <div class="form-login mx-auto">
      ...
      <div class="login-field">
        ...
        <div class="password">
          ...
          <input
            ...
            :class="[
              !password && clickedSubmit ? 'error-type-password' : '',
              !password ? 'normalplaceholder' : '',
            ]"
            ref="passwordCl"
        ...
        <div class="remember-me">
          ...
          <label
            for="checkbox"
            class="text remember-label"
            style="opacity: 0.6; cursor: pointer"
          >
            <img
              v-show="rememberMe"
              src="../../assets/rememberme.png"
              alt=""
              class="mr-3"
            />
            <img
              v-show="!rememberMe"
              src="../../assets/rememberme_u.png"
              alt=""
              class="mr-3"
            />
            Save password</label
      ...
      <div
        ...
        @click="submit"
        :class="loadingLogin ? 'disable-btn-m' : ''"
      >
        Sign in<img
          v-show="loadingLogin"
