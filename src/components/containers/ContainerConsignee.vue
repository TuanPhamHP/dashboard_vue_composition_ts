<template>
 <div class="page-container-consignee">
  ...
  <div class=" page-content">
   ...
   <TableConsignee :table-data="tableData" :table-loading="loadingTable" :headers="headers" @handleFilterChange="filterTableChange" @handleSelectedItem="handlerEdit" :current-binding-url="queryRoute" @handleSelectedItemDetail="handlerViewDetail" />
   <div class="pt-1">
