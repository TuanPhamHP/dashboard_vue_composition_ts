<template>
 <div class="page-container-manifest">
  ...
  <div class="page-content">
   ...
   <v-btn color="#2F6BFF" @click="handleOpenCreate" class="mb-3 create-button"
    ><img src="../../assets/images/plus-composer.png" width="15px" height="15px" style="margin-right: 16px" /> Create</v-btn
   >
   <v-btn @click="setupData" class="mb-3 mx-3 export-button"
    ><img src="../../assets/images/export-b.png" width="21px" height="21px" style="margin-right: 16px" />Export</v-btn
   >
   <div>
    <TableManifest
