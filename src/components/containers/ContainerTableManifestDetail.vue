   ...
   <div style="display: flex">
    ...
    <div class="buttons">
     <v-btn @click="setupData" class="mb-3 mx-3 export-button"
      ><img src="../../assets/images/vector.png" width="21px" height="21px" style="margin-right: 16px" />Export</v-btn
     >
     <v-btn color="#2F6BFF" @click="setupData" class="mb-3 mx-3 create-button"
      ><img src="../../assets/images/save-icon.png" width="18px" height="18px" style="margin-right: 16px" /> Save</v-btn
     >
    </div>
   </div>
   <p class="font-size-16 add-bag text-decoration-underline pointer display-inline-block" @click="isVisible = true">Add a new bag</p>
   <div>
    <TableManifestDetail :table-data="tableData" :table-loading="loadingTable" :headers="headers" @handleFilterChange="filterTableChange" />
   </div>
  </div>
 </div>
</template>
